...
(use-package perspective
  :bind (("C-c b" . persp-switch-to-buffer*)
  :config
  (persp-mode))

(global-set-key (kbd "C-c C-b") (lambda (arg)
                                  (interactive "P")
...
;; tramp - added for docker settings.
;; workspaces - perspective package should take care of basics.
